    ...
    <div className="container mx-auto ">
      ...
      <form action="https://getform.io/f/6dBxgWa7" method="POST" className='flex flex-col justify-center items-center gap-4 lg:gap-10 2xl:gap-14 mt-4 lg:text-xl 2xl:text-2xl text-lg text-[#1D267D] '>
        ...
        <div className='text-left flex flex-col mt-4'>
          <label htmlFor="date1" className='px-8 2xl:px-12 xl:text-2xl mb-2'>Start date:</label>
          <SelectDate changeDate={changeDate1}/>
        </div>
        <div className='text-left flex flex-col mt-4'>
          <label htmlFor="date2" className='px-8 2xl:px-12 xl:text-2xl mb-2'>Return date:</label>
          <SelectDate changeDate={changeDate2}/>
        </div>
        <input value={formData.date1} type="hidden" id='start_date' name='start_date' className='invisible' />
        <input value={formData.date2} type="hidden" id='return_date' name='return_date' className='invisible' />
